        ...
        stage('ZAP'){
        	steps{
        		...
        		script{
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:192.168.100.4" -v $(pwd):/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-baseline.py -t "https://demo.testfire.net/" -I -r zap_baseline_report2.html -l PASS'
        		}
        	}
        }
